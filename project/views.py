...
from django.contrib.auth.decorators import login_required # login required if user not login.

# import class Project and ProjectNote from model.py
from .models import Project,ProjectNote

# send uploadfile help of this model
